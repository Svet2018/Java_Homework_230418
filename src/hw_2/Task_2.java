...
public class Task_2 {
    ...
    //public static final String PATH = "/hw_2/kookbook.txt";


    protected static void fileFile(){
        String PATH = "hw_2/kookbook.txt";
    ...
    //Метод запрашивает количество чего-либо
    ...
    //Метод запрашивает продукты аллергены и их замена
    protected static String [] foodIn(int num){
        String [] foodStr = new String[num];
        for (int i = 0; i < foodStr.length; i++) {
            Scanner scanner = new Scanner(System.in);
            String food = scanner.nextLine();
        }
        for (String s : foodStr) { //System.out.println(foodStr);
        }
        return foodStr;
    }
